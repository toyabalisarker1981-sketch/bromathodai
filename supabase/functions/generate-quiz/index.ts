...
3. তথ্যভিত্তিক, প্রয়োগমূলক ও সৃজনশীল — তিন ধরনের মিশ্রণ রাখো
...
- তথ্যভিত্তিক, প্রয়োগমূলক এবং সৃজনশীল প্রশ্নের সমন্বয় রাখো`;
    }
...
${analyticalCount > 0 ? `সৃজনশীল/সৃজনশীল প্রশ্নের জন্য:
- প্রশ্ন (বাংলায়)
